...
@Schema(name = "PartialMotivationActorResponse", description = "This object represents a MotivationActorJunction item.")
public class PartialMotivationActorResponse {
    @Schema(
