...
@Tag(name = "Zenodo")
    ...
    @SecurityRequirement(name = "Authentication")
    @POST
    @Path("/zenodo/publish/{assessment-id}")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    public Response publishZenodoAssessment(@Parameter(
                                                    ...
                                                    required = true,
                                                    example = "c242e43f-9869-4fb0-b881-631bc5746ec0",
                                                    schema = @Schema(type = SchemaType.STRING)) @PathParam("assessment-id")
    ...
    public Response getZenodoAssessment(@Parameter(
        ...
        var response = zenodoService.getAssessment(assessmentId);
        return Response.ok().entity(response).build();
    }

    @Tag(name = "Zenodo")
    @Operation(
            summary = "Get Info about a depoisit in Zenodo.",
    ...
    @SecurityRequirement(name = "Authentication")
    @GET
    @Path("/zenodo/deposit/{deposit-id}")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    public Response getZenodoDeposit(@Parameter(
            ...
            required = true,
            example = "13467",
            schema = @Schema(type = SchemaType.STRING)) @PathParam("deposit-id")
                                     String depositId) {
        var response = zenodoService.getDeposit(depositId, utility.getUserUniqueIdentifier());
        return Response.ok().entity(response).build();
    }
    ...
    @SecurityRequirement(name = "Authentication")
    @POST
    @Path("/zenodo/publish/deposit/{deposit-id}")
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    @Registration
    public Response publishZenodoDeposit(@Parameter(
            ...
            required = true,
            example = "183367",
            schema = @Schema(type = SchemaType.STRING)) @PathParam("deposit-id") String depositId) {
