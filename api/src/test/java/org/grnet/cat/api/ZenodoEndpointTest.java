...
//    Config config;
//
//    private static String zenodoKey;
...
//        zenodoKey = config.getValue("zenodo.api.key", String.class);
//        makeSettingRequest(adminToken);
...
//    }
//
//    private void makeSettingRequest(String userToken) {
//        var requestBody = "{\n" +
//                "  \"data\": {\n" +
//                "    \"key\": \"" + "zenodo.api.key" + "\",\n" +
//                "    \"value\": \"" + zenodoKey + "\"\n" +
