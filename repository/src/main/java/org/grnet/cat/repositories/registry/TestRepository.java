...
public class TestRepository implements Repository<Test, String> {
    ...
    public PageQuery<Test> fetchTestAllVersions(String lodTES_V, int page, int size) {

        var panache = find("FROM Test t WHERE t.lodTES_V = ?1 ORDER BY t.version DESC", lodTES_V) ;
