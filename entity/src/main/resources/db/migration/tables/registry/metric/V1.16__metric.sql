...
ALTER TABLE p_Metric ADD CONSTRAINT fk_metric_type_alogorithm FOREIGN KEY (lodTAL) REFERENCES t_Type_Algorithm (lodTAL);
ALTER TABLE p_Metric ADD CONSTRAINT fk_metric_type_metric FOREIGN KEY (lodTMT) REFERENCES t_Type_Metric (lodTMT);
...
INSERT INTO p_Metric (MTR, lodMTR, labelMetric, descrMetric, urlMetric, lodTAL, lodTMT, lodMTV, lodMTR_V, upload, dataType)
VALUES ('M36', 'pid_graph:2604D968', 'PID Recommendation Compliance', 'Evidence is provided of compliance with recommended PIDs for a number of entities', NULL, 'pid_graph:AE39C968', 'pid_graph:8D79984F', 'pid_graph:34A9189F', NULL, '2024-09-09', 'Test');
