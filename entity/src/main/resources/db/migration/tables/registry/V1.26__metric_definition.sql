...
CREATE TABLE p_Metric_Definition (
    ...
    lodReference2 VARCHAR(255) DEFAULT NULL,
    lodReference VARCHAR(255) DEFAULT NULL,
    upload DATE DEFAULT NULL,
    dataType VARCHAR(255) DEFAULT NULL,
    PRIMARY KEY (metric_lodMTR, type_benchmark_lodTBN, motivation_lodMTV, lodM_TB_V),
