...
INSERT p_Test (lodTES , TES , labelTest, descTest, lodMTV , lodTES_V) VALUES ('pid_graph:333489E8', 'MD-1a', 'Administrative Contact Details', 'administrative contact details for the AA Operator, including at least one role-based email address and one postal contact address',  'pid_graph:5EB0885A',1);
INSERT p_Test (lodTES , TES , labelTest, descTest, lodMTV , lodTES_V) VALUES ('pid_graph:391489E8', 'MD-1b1', 'Operational Security Contact Email', 'an operational security contact for the AA Operator, being at least a role-based email address',  'pid_graph:5EB0885A',1);
INSERT p_Test (lodTES , TES , labelTest, descTest, lodMTV , lodTES_V) VALUES ('pid_graph:341399E8', 'MD-1b2', 'Operational Security Contact Phone Number','an operational security contact for the AA Operator, preferably including a telephone number',  'pid_graph:5EB0885A',1);
INSERT p_Test (lodTES , TES , labelTest, descTest, lodMTV , lodTES_V) VALUES ('pid_graph:661267E8', 'MD-1c', 'Cryptographic Key Material', 'cryptographic key material required to verify signed messages, where that is required to validate issued attribute assertions',  'pid_graph:5EB0885A',1);
