...
-- The relations copied include MotivationActor, ActorCriterion, PrincipleCriterion, CriterionMetric, MetricTest.
-- This procedure updates the 'motivation_id' to the new one while keeping other data the same,
-- including setting the 'lastTouch' to the current timestamp for the copied records. (version 3)
-- --
