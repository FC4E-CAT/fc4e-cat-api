...
-- Version: v1.83
--
-- Description: Stored Procedure to copy all relations from an existing motivation to a new version of the motivation version 2
-- -------------------------------------------------

CREATE OR REPLACE PROCEDURE CopyRelationsToVersionMotivation(
