...
-- Version: v1.45
--
-- Description: Migration that updates the manager template json document in version 3
-- -------------------------------------------------
      ...
      "criteria": [
        {
          ...
          "metric": {
            ...
            "tests": [
            {
                ...
                "guidance": {
                  "id": "G2",
                  "description": "guidance on how to annotate and reference public evidence of the board’s existence and composition, and how to verify that the board represents stakeholders."
                },
