...
-- Version: v1.28
--
-- Description: Migration that adds a new template for the PID Service Provider actor
-- -------------------------------------------------
            ...
            "tests": [
              {
                ...
                "text": "Can you provide evidence of a contract between Services and Managers exists?",
                "value": null,
                "result": null,
                "guidance": {
                  "id": "G29",
